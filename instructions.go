...
func (ILLEGAL_FC_FC) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_FC_FC")
...
func (RRCA_0F) Exec(cpu *CPU) {
	cpu.A, cpu.F = rotate(cpu.A, 1, cpu.F, true)
	cpu.Cycles += 4
}
func (RRCA_0F) Code() uint8 {
	return 0xF
}
func (RRCA_0F) String() string {
	return "RRCA"
}
...
func (ILLEGAL_ED_ED) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_ED_ED")
...
func (ILLEGAL_DD_DD) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_DD_DD")
...
func (ILLEGAL_EB_EB) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_EB_EB")
...
func (ILLEGAL_F4_F4) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_F4_F4")
...
func (ILLEGAL_E4_E4) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_E4_E4")
...
func (ILLEGAL_E3_E3) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_E3_E3")
...
func (ILLEGAL_FD_FD) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_FD_FD")
...
func (ILLEGAL_DB_DB) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_DB_DB")
...
func (ILLEGAL_D3_D3) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_D3_D3")
...
func (ILLEGAL_EC_EC) Exec(cpu *CPU) {
	fmt.Println("TODO: ILLEGAL_EC_EC")
...
func (SET_FE) Exec(cpu *CPU) {
	v := cpu.loadU8(cpu.HL()) | (1 << 7)
	cpu.WriteMemory(cpu.HL(), v)
	cpu.Cycles += 16
}
...
func (RES_96) Exec(cpu *CPU) {
	res := cpu.loadU8(cpu.HL()) & ^uint8(1<<2)
	cpu.WriteMemory(cpu.HL(), res)
	cpu.Cycles += 16
}
...
func (RES_8E) Exec(cpu *CPU) {
	res := cpu.loadU8(cpu.HL()) & ^uint8(1<<1)
	cpu.WriteMemory(cpu.HL(), res)
	cpu.Cycles += 16
}
...
func (RES_AE) Exec(cpu *CPU) {
	res := cpu.loadU8(cpu.HL()) & ^uint8(1<<5)
	cpu.WriteMemory(cpu.HL(), res)
	cpu.Cycles += 16
}
...
func (RES_9E) Exec(cpu *CPU) {
	res := cpu.loadU8(cpu.HL()) & ^uint8(1<<3)
	cpu.WriteMemory(cpu.HL(), res)
	cpu.Cycles += 16
}
...
func (RES_B6) Exec(cpu *CPU) {
	res := cpu.loadU8(cpu.HL()) & ^uint8(1<<6)
	cpu.WriteMemory(cpu.HL(), res)
	cpu.Cycles += 16
}
...
func (RES_86) Exec(cpu *CPU) {
	res := cpu.loadU8(cpu.HL()) & ^uint8(1<<0)
	cpu.WriteMemory(cpu.HL(), res)
	cpu.Cycles += 16
}
...
func (RES_A6) Exec(cpu *CPU) {
	res := cpu.loadU8(cpu.HL()) & ^uint8(1<<4)
	cpu.WriteMemory(cpu.HL(), res)
	cpu.Cycles += 16
}
...
func (RES_BE) Exec(cpu *CPU) {
	res := cpu.loadU8(cpu.HL()) & ^uint8(1<<7)
	cpu.WriteMemory(cpu.HL(), res)
	cpu.Cycles += 16
}
